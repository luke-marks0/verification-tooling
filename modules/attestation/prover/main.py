...
Usage:
    python3 modules/attestation/prover/main.py \\
...
from modules.core.common.contracts import ValidationError, validate_with_schema  # noqa: E402
...
from modules.attestation.proverdet.replay import check_supported, produce_evidence_stream  # noqa: E402
from modules.attestation.proverdet.traffic_publisher import TrafficPublisher  # noqa: E402
from modules.attestation.proverdet.wire import ReplayRequest  # noqa: E402
...
class ProverState:
    ...
    Mirrors `modules/inference/server/main.py`'s `ServerState` shape but only owns what the

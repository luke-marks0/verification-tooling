...
Usage:
    python3 modules/attestation/verifier_cli/main.py \\
...
from modules.core.common.deterministic import canonical_json_text  # noqa: E402
from modules.attestation.proverdet.verdict import emit_verdict  # noqa: E402
